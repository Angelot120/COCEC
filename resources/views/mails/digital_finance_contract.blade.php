...
<head>
    ...
    <title>Confirmation de votre contrat - COCEC Finance Digitale</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Nous avons bien reçu votre contrat d'adhésion aux services de finance digitale de la COCEC.</p>

            <div class="highlight">
                <p><strong>Votre contrat a été enregistré avec succès !</strong></p>
                <p>Notre équipe va examiner votre demande et vous contacter dans les plus brefs délais pour finaliser votre adhésion.</p>
            </div>

            <div class="services-info">
                <p><strong>📱 Services disponibles :</strong></p>
                <ul>
                    <li><strong>Mobile Money :</strong> 1000 F/an</li>
                    <li><strong>Mobile Banking :</strong> 1000 F/an</li>
                    <li><strong>Web Banking :</strong> 600 F/an</li>
                    <li><strong>SMS Banking :</strong> 100 F/mois</li>
                </ul>
            </div>
            ...
            <ul>
                ...
                <li>Envoi de vos identifiants BINDOO</li>
                <li>Formation à l'utilisation des services</li>
            </ul>
