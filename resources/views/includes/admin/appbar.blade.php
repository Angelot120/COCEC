    ...
    <div class="row align-items-center justify-content-between">
        ...
        <div class="col-auto">
            {{-- <div class="d-flex flex-wrap align-items-center gap-3">
                <button type="button" data-theme-toggle class="w-40-px h-40-px bg-neutral-200 ro<div class="dropdown">
                    <button
            ...
            </div>Notification dropdown endunded-circle d-flex justify-content-center align-items-center"></button> --}}
            ...
            <div class="dropdown">
                <button class="d-flex justify-content-center align-items-center rounded-circle" type="button"
                    ...
                    @else
                        <div
                            class="w-40-px h-40-px bg-{{ Auth::user()->role->value === 'super_admin' ? 'danger' : (Auth::user()->role->value === 'dg' ? 'warning' : (Auth::user()->role->value === 'informaticien' ? 'info' : 'success')) }} rounded-circle d-flex justify-content-center align-items-center">
                ...
                <div class="dropdown-menu to-top dropdown-menu-sm">
                    <div
                        ...
                        <div>
                            ...
                            <span
                                class="text-secondary-light fw-medium text-sm">{{ Auth::user()->role->getLabel() }}</span>
                        </div>
                    ...
                    <ul class="to-top-list">
                        ...
                        {{-- <li>
                            <a class="dropdown-item text-black px-0 py-8 hover-bg-transparent hover-text-primary d-flex align-items-center gap-3"
                                href="{{ route('settings.localities') }}">
                                <iconify-icon icon="icon-park-outline:setting-two"
                                    class="icon text-xl"></iconify-icon> Paramètres</a>
                        </li> --}}
                        <li>
