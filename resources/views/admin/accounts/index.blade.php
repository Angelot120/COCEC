            ...
            <div class="col-12">
                <div class="card shadow-none border">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('accounts.physical.index') }}" class="btn btn-primary btn-sm">
                            Voir tous
                        </a>
                    </div>
                    <div class="card-body">
                                    ...
                                    <tbody>
                                        @foreach($physicalSubmissions as $submission)
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="badge bg-{{ $submission->statut === 'en_attente' ? 'warning' : ($submission->statut === 'accepter' ? 'success' : 'danger') }}">
                                                        {{ $submission->statut === 'en_attente' ? 'En attente' : ($submission->statut === 'accepter' ? 'Accepté' : 'Refusé') }}
                                                    </span>
                                                </td>
                                                <td>{{ $submission->created_at->format('d/m/Y H:i') }}</td>
                                                <td>
                                                    <a href="{{ route('accounts.physical.show', $submission->id) }}" class="btn btn-sm btn-info">
            ...
            <div class="col-12">
                <div class="card shadow-none border">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('accounts.moral.index') }}" class="btn btn-primary btn-sm">
                            Voir tous
                        </a>
                    </div>
                    <div class="card-body">
                                    ...
                                    <tbody>
                                        @foreach($moralSubmissions as $submission)
                                            <tr>
                                                ...
                                                <td>{{ $submission->created_at->format('d/m/Y H:i') }}</td>
                                                <td>
                                                    <a href="{{ route('accounts.moral.show', $submission->id) }}" class="btn btn-sm btn-info">
                                                        <i class="fas fa-eye"></i>
                                                    </a>
                                                </td>
                                            </tr>
