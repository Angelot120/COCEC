...
<body>
    <div class="header <?php echo e($submission->photo_path ? '' : 'no-photo'); ?>">
        ...
        <div class="header-photo">
            ...
            ?>
            <?php if($imageSrc): ?>
                <img src="<?php echo e($imageSrc); ?>" alt="Photo d'identité">
            <?php endif; ?>
        </div>
        <?php endif; ?>
    ...
    <div class="section">
        ...
        <div class="info-grid">
            <div class="info-item"><span class="info-label">Nom</span><span class="info-value"><?php echo e($submission->last_name); ?></span></div>
            <div class="info-item"><span class="info-label">Prénoms</span><span class="info-value"><?php echo e($submission->first_names); ?></span></div>
            <div class="info-item"><span class="info-label">Genre</span><span class="info-value"><?php echo e($submission->gender == 'M' ? 'Masculin' : 'Féminin'); ?></span></div>
            <div class="info-item"><span class="info-label">Date de naissance</span><span class="info-value"><?php echo e($submission->birth_date ? $submission->birth_date->format('d/m/Y') : 'N/A'); ?></span></div>
            <div class="info-item"><span class="info-label">Lieu de naissance</span><span class="info-value"><?php echo e($submission->birth_place); ?></span></div>
            <div class="info-item"><span class="info-label">Nationalité</span><span class="info-value"><?php echo e($submission->nationality); ?></span></div>
            <div class="info-item"><span class="info-label">Nom du père</span><span class="info-value"><?php echo e($submission->father_name ?? 'N/A'); ?></span></div>
            <div class="info-item"><span class="info-label">Nom de la mère</span><span class="info-value"><?php echo e($submission->mother_name ?? 'N/A'); ?></span></div>
            <div class="info-item"><span class="info-label">Téléphone</span><span class="info-value"><?php echo e($submission->phone ?? 'N/A'); ?></span></div>
            <div class="info-item"><span class="info-label">Adresse</span><span class="info-value"><?php echo e($submission->address ?? 'N/A'); ?></span></div>
        </div>
    </div>
    ...
    <div class="section">
        ...
        <div class="info-grid">
            <div class="info-item"><span class="info-label">Statut marital</span><span class="info-value"><?php echo e($submission->marital_status ?? 'N/A'); ?></span></div>
            <div class="info-item"><span class="info-label">Nom du conjoint</span><span class="info-value"><?php echo e($submission->spouse_name ?? 'N/A'); ?></span></div>
            <div class="info-item"><span class="info-label">Profession</span><span class="info-value"><?php echo e($submission->occupation ?? 'N/A'); ?></span></div>
            <div class="info-item"><span class="info-label">Entreprise</span><span class="info-value"><?php echo e($submission->company_name_activity ?? 'N/A'); ?></span></div>
            <div class="info-item"><span class="info-label">Numéro de pièce</span><span class="info-value"><?php echo e($submission->id_number ?? 'N/A'); ?></span></div>
            <div class="info-item"><span class="info-label">Date d'émission</span><span class="info-value"><?php echo e($submission->id_issue_date ? $submission->id_issue_date->format('d/m/Y') : 'N/A'); ?></span></div>
        </div>
    </div>
    ...
    <div class="section compact">
        ...
        <table class="payment-table">
            ...
            <tbody>
                ...
                <tr><td>Dépôts</td><td style="text-align: right;"><?php echo e(number_format($submission->initial_deposit ?? 0, 0, ',', ' ')); ?></td></tr>
                <tr class="total-row"><td><strong>TOTAL</strong></td><td style="text-align: right;"><strong><?php echo e(number_format(2000 + 15000 + ($submission->initial_deposit ?? 0), 0, ',', ' ')); ?></strong></td></tr>
            </tbody>
        </table>
    </div>
    ...
    <div class="section">
        ...
        <p class="prose">
            L'an <?php echo e($submission->created_at->format('Y')); ?>, le <?php echo e($submission->created_at->format('d/m/Y')); ?>, je soussigné(e) <strong><?php echo e($submission->last_name); ?> <?php echo e($submission->first_names); ?></strong> déclare vouloir adhérer à la COCEC et ouvrir un compte d'épargne.
        </p>
         <p class="prose">
            Je soussigné(e), <strong><?php echo e($submission->last_name); ?> <?php echo e($submission->first_names); ?></strong>, atteste sur l'honneur que les informations fournies sont exactes et sincères, et reconnais que toute fausse déclaration peut entraîner le rejet de cette demande ou la clôture du compte.
        </p>
