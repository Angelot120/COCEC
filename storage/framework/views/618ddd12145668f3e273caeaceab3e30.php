    ...
    <section class="auth bg-base d-flex flex-wrap">
        <div class="auth-left d-lg-block d-none">
            <div class="d-flex align-items-center flex-column h-100 justify-content-center">
                <img src="<?php echo e(URL::asset('assets/images/accompagnement.jpg')); ?>" alt="" >
            </div>
        </div>
        <div class="auth-right py-32 px-24 d-flex flex-column justify-content-center">
            <div class="max-w-464-px mx-auto w-100">
                <div>
                    <div class="text-center">
                        <a href="index.html" class="mb-40 max-w-290-px">
                            <img src="<?php echo e(URL::asset('assets/images/logo.png')); ?>" alt="" style="max-width: 120px; height: auto;">
                        </a>
                    </div>
                ...
                <div style="color: red;"><?php echo e($message); ?></div><br>
                <?php endif; ?>

                <form id="loginForm" action="<?php echo e(route('login.process')); ?>" method="POST" onsubmit="showLoading()">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\user\Desktop\Microfinance\COCEC\resources\views/auth/login.blade.php ENDPATH**/ ?>