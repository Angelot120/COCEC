...
<body>
    <div class="email-container">
        <div class="header">
            <img src="<?php echo e(asset('assets/images/Logo.png')); ?>" alt="COCEC Logo" class="logo">
        ...
        <div class="content">
            <div class="greeting">
                Bonjour <strong><?php echo e($name); ?></strong>,
            </div>

            <p>Votre compte utilisateur a été créé avec succès sur la plateforme COCEC.</p>

            <div class="info-box">
                <p><strong>Rôle attribué :</strong> <?php echo e($role ?? 'Utilisateur'); ?></p>
                <?php if($phone_num): ?>
                    <p><strong>Téléphone :</strong> <?php echo e($phone_num); ?></p>
                <?php endif; ?>
            </div>
            ...
            <div class="credentials">
                ...
                <div class="credential-item">
                    ...
                    <span class="credential-value"><?php echo e($email); ?></span>
                </div>
                
                <div class="credential-item">
                    <span class="credential-label">Mot de passe :</span>
                    <span class="credential-value"><?php echo e($password); ?></span>
                </div>
            </div>
            ...
            <div style="text-align: center;">
                <a href="<?php echo e(url('/login')); ?>" class="button">Se connecter maintenant</a>
            </div>
        ...
        <div class="footer">
            ...
            <p>© <?php echo e(date('Y')); ?> COCEC. Tous droits réservés.</p>
        </div>
    </div>
</body>
</html>
<?php /**PATH C:\Users\user\Desktop\Microfinance\COCEC\resources\views/mails/new-account.blade.php ENDPATH**/ ?>