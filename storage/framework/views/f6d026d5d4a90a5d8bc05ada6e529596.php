...
unset($__errorArgs, $__bag); ?>">
                        ...
                        <option value="Open" <?php echo e(old('status') == 'Open' ? 'selected' : ''); ?>>Ouverte les samedi</option>
                        <option value="Close" <?php echo e(old('status') == 'Close' ? 'selected' : ''); ?>>Fermée les samedi</option>
                    </select>
...
<?php echo $__env->make('layout.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\COCEC\resources\views/admin/agency/create.blade.php ENDPATH**/ ?>