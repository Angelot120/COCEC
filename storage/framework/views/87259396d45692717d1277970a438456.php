...
<?php $__env->startSection('content'); ?>
        ...
        <div class="dashboard-main-body">
            ...
            <div class="card h-100 p-0 radius-12">
                <div
                    ...
                    <form action="<?php echo e(route('career.index')); ?>" method="GET"
                    ...
                    <a href="<?php echo e(route('career.create')); ?>"
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <?php if($job_offer->status === 'open'): ?>
                                                <span
                                                    class="bg-success-focus text-success-600 border border-success-main px-24 py-4 radius-4 fw-medium text-sm">Ouvert</span>
                                            <?php else: ?>
                                                <span
                                                    class="bg-neutral-200 text-neutral-600 border border-neutral-400 px-24 py-4 radius-4 fw-medium text-sm">Fermé</span>
                                            <?php endif; ?>
                                        </td>
                                        <td class="text-center">
                                            <div class="d-flex align-items-center gap-10 justify-content-center">
                                                <!-- Bouton VOIR (remplacé par lien) -->
                                                <a href="<?php echo e(route('jobOffer.details', $job_offer->id)); ?>"
                                                ...
                                                <button type="button"
                                                    ...
                                                    data-bs-target="#editJobOfferModal<?php echo e($job_offer->id); ?>">
                                                    <iconify-icon icon="lucide:edit" class="menu-icon"></iconify-icon>
                                                </button>

                                                <!-- Bouton SUPPRIMER -->
                                                <form method="POST" action="<?php echo e(route('career.destroy', $job_offer->id)); ?>"
    ...
    <?php $__currentLoopData = $job_offers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $job_offer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="modal fade" id="editJobOfferModal<?php echo e($job_offer->id); ?>" tabindex="-1"
            aria-labelledby="editJobOfferModalLabel<?php echo e($job_offer->id); ?>" aria-hidden="true">
                ...
                <div class="modal-content">
                    <form method="POST" action="<?php echo e(route('career.update', $job_offer->id)); ?>">
                        ...
                        <div class="modal-header">
                            <h5 class="modal-title" id="editJobOfferModalLabel<?php echo e($job_offer->id); ?>">Modifier l'offre :
                                <?php echo e($job_offer->title); ?></h5>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="title" id="title<?php echo e($job_offer->id); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                    value="<?php echo e(old('title', $job_offer->title)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="type" id="type<?php echo e($job_offer->id); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                    ...
                                    <option value="stage"
                                        <?php echo e(old('type', $job_offer->type) == 'stage' ? 'selected' : ''); ?>>Stage</option>
                                    <option value="emploi"
                                        <?php echo e(old('type', $job_offer->type) == 'emploi' ? 'selected' : ''); ?>>Emploi</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="status" id="status<?php echo e($job_offer->id); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                    ...
                                    <option value="open"
                                        <?php echo e(old('status', $job_offer->status) == 'open' ? 'selected' : ''); ?>>Ouvert</option>
                                    <option value="closed"
                                        <?php echo e(old('status', $job_offer->status) == 'closed' ? 'selected' : ''); ?>>Fermé
                                    </option>
                                </select>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-3">
                                <label for="bref_description<?php echo e($job_offer->id); ?>" class="form-label">Brève description
                                    *</label>
                                <textarea name="bref_description" id="bref_description<?php echo e($job_offer->id); ?>"
                                    class="form-control <?php $__errorArgs = ['bref_description', 'update-' . $job_offer->id];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" rows="3"
                                    required><?php echo e(old('bref_description', $job_offer->bref_description)); ?></textarea>
                                <?php $__errorArgs = ['bref_description', 'update-' . $job_offer->id];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="description" id="description<?php echo e($job_offer->id); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                    rows="5" required><?php echo e(old('description', $job_offer->description)); ?></textarea>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            <?php if(session('edit_job_offer_id')): ?>
                ...
                'editJobOfferModal<?php echo e(session('edit_job_offer_id')); ?>');
                if (modalElement) {
...
<?php echo $__env->make('layout.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\user\Desktop\Microfinance\COCEC\resources\views/admin/career/index.blade.php ENDPATH**/ ?>