...
<body>
    ...
    <div class="section">
        ...
        <div class="info-grid">
            <div class="info-item">
                ...
                <span class="info-value"><?php echo e($submission->company_name ?? 'N/A'); ?></span>
            </div>
            <div class="info-item">
                <span class="info-label">Catégorie</span>
                <span class="info-value"><?php echo e($submission->category ?? 'N/A'); ?></span>
            </div>
            <div class="info-item">
                <span class="info-label">RCCM</span>
                <span class="info-value"><?php echo e($submission->rccm ?? 'N/A'); ?></span>
            </div>
            <div class="info-item">
                <span class="info-label">Secteur d'activité</span>
                <span class="info-value"><?php echo e($submission->activity_sector ?? 'N/A'); ?></span>
            </div>
            <div class="info-item">
                <span class="info-label">Date de création</span>
                <span class="info-value"><?php echo e($submission->creation_date ? $submission->creation_date->format('d/m/Y') : 'N/A'); ?></span>
            </div>
            <div class="info-item">
                <span class="info-label">Lieu de création</span>
                <span class="info-value"><?php echo e($submission->creation_place ?? 'N/A'); ?></span>
            </div>
            <div class="info-item">
                <span class="info-label">Nationalité</span>
                <span class="info-value"><?php echo e($submission->company_nationality ?? 'N/A'); ?></span>
            </div>
            <div class="info-item">
                <span class="info-label">Téléphone</span>
                <span class="info-value"><?php echo e($submission->company_phone ?? 'N/A'); ?></span>
            </div>
            <div class="info-item full-width">
                <span class="info-label">Adresse complète</span>
                <span class="info-value"><?php echo e($submission->company_address ?? 'N/A'); ?></span>
            </div>
            <?php if(!empty($submission->activity_description)): ?>
            <div class="info-item full-width">
                <span class="info-label">Description de l'activité</span>
                <span class="info-value"><?php echo e($submission->activity_description); ?></span>
            </div>
            <?php endif; ?>
        </div>
        
        
        <?php if(!empty($submission->company_lat) && !empty($submission->company_lng)): ?>
        <div style="margin-top: 10mm;">
            ...
            <div style="text-align: center; border: 2px solid #EC281C; padding: 5mm; background: #f8f9fa; border-radius: 5px;">
                <img src="https://api.mapbox.com/styles/v1/mapbox/streets-v11/static/pin-s+ff0000(<?php echo e($submission->company_lng); ?>,<?php echo e($submission->company_lat); ?>)/<?php echo e($submission->company_lng); ?>,<?php echo e($submission->company_lat); ?>,15,0/400x200@2x?access_token=pk.eyJ1IjoibWFwYm94IiwiYSI6ImNpejY4NXVycTA2emYycXBndHRqcmZ3N3gifQ.rJcFIG214AriISLbB6B5aw" 
    ...
    <div class="section">
        ...
        <div class="info-grid">
            <div class="info-item">
                ...
                <span class="info-value"><?php echo e(($submission->director_name ?? '') . ' ' . ($submission->director_first_name ?? '')); ?></span>
            </div>
            <div class="info-item">
                <span class="info-label">Poste</span>
                <span class="info-value"><?php echo e($submission->director_position ?? 'N/A'); ?></span>
            </div>
            <div class="info-item">
                <span class="info-label">Genre</span>
                <span class="info-value"><?php echo e(($submission->director_gender ?? '') == 'M' ? 'Masculin' : (($submission->director_gender ?? '') == 'F' ? 'Féminin' : 'N/A')); ?></span>
            </div>
            <div class="info-item">
                <span class="info-label">Nationalité</span>
                <span class="info-value"><?php echo e($submission->director_nationality ?? 'N/A'); ?></span>
            </div>
            <div class="info-item">
                <span class="info-label">Date de naissance</span>
                <span class="info-value"><?php echo e($submission->director_birth_date ? $submission->director_birth_date->format('d/m/Y') : 'N/A'); ?></span>
            </div>
            <div class="info-item">
                <span class="info-label">Lieu de naissance</span>
                <span class="info-value"><?php echo e($submission->director_birth_place ?? 'N/A'); ?></span>
            </div>
            <div class="info-item">
                <span class="info-label">N° Pièce d'identité</span>
                <span class="info-value"><?php echo e($submission->director_id_number ?? 'N/A'); ?></span>
            </div>
            <div class="info-item">
                <span class="info-label">Date d'émission</span>
                <span class="info-value"><?php echo e($submission->director_id_issue_date ? $submission->director_id_issue_date->format('d/m/Y') : 'N/A'); ?></span>
            </div>
            <div class="info-item">
                <span class="info-label">Téléphone</span>
                <span class="info-value"><?php echo e($submission->director_phone ?? 'N/A'); ?></span>
            </div>
            <div class="info-item">
                <span class="info-label">Nom du père</span>
                <span class="info-value"><?php echo e($submission->director_father_name ?? 'N/A'); ?></span>
            </div>
            <div class="info-item">
                <span class="info-label">Nom de la mère</span>
                <span class="info-value"><?php echo e($submission->director_mother_name ?? 'N/A'); ?></span>
            </div>
        </div>
    </div>
    ...
    <div class="section">
        ...
        <div class="info-grid">
            <div class="info-item">
                ...
                <span class="info-value"><?php echo e($submission->director_spouse_name ?? 'N/A'); ?></span>
            </div>
            <div class="info-item">
                <span class="info-label">Prénom</span>
                <span class="info-value"><?php echo e($submission->director_spouse_first_name ?? 'N/A'); ?></span>
            </div>
            <div class="info-item">
                <span class="info-label">Profession</span>
                <span class="info-value"><?php echo e($submission->director_spouse_profession ?? 'N/A'); ?></span>
            </div>
            <div class="info-item">
                <span class="info-label">Téléphone</span>
                <span class="info-value"><?php echo e($submission->director_spouse_phone ?? 'N/A'); ?></span>
            </div>
            <div class="info-item full-width">
                <span class="info-label">Adresse</span>
                <span class="info-value"><?php echo e($submission->director_spouse_address ?? 'N/A'); ?></span>
            </div>
        </div>
    </div>
    ...
    <div class="section">
        ...
        <div class="info-grid">
            <div class="info-item">
                ...
                <span class="info-value"><?php echo e($submission->emergency_contact_name ?? 'N/A'); ?></span>
            </div>
            <div class="info-item">
                <span class="info-label">Téléphone</span>
                <span class="info-value"><?php echo e($submission->emergency_contact_phone ?? 'N/A'); ?></span>
            </div>
            <div class="info-item full-width">
                <span class="info-label">Adresse</span>
                <span class="info-value"><?php echo e($submission->emergency_contact_address ?? 'N/A'); ?></span>
            </div>
        </div>
    </div>
    ...
    <div class="section">
        ...
        <div class="info-grid">
            <div class="info-item">
                ...
                <span class="info-value"><?php echo e(($submission->is_ppe_national ?? false) ? 'Oui' : 'Non'); ?></span>
            </div>
            <div class="info-item">
                <span class="info-label">Personne politiquement exposée (étrangère)</span>
                <span class="info-value"><?php echo e(($submission->ppe_foreign ?? false) ? 'Oui' : 'Non'); ?></span>
            </div>
            <div class="info-item">
                <span class="info-label">Sanction financière internationale</span>
                <span class="info-value"><?php echo e((($submission->sanctions ?? 'Non') !== 'Non') ? 'Oui' : 'Non'); ?></span>
            </div>
            <div class="info-item">
                <span class="info-label">Financement du terrorisme</span>
                <span class="info-value"><?php echo e((($submission->terrorism_financing ?? 'Non') !== 'Non') ? 'Oui' : 'Non'); ?></span>
            </div>
            <?php if(!empty($submission->sanctions) && $submission->sanctions !== 'Non'): ?>
            <div class="info-item full-width">
                <span class="info-label">Détails des sanctions</span>
                <span class="info-value"><?php echo e($submission->sanctions); ?></span>
            </div>
            <?php endif; ?>
        </div>
    </div>
    ...
    <?php if(isset($submission->accountSignatories) && !$submission->accountSignatories->isEmpty()): ?>
    <div class="section">
        ...
        <table class="table">
            ...
            <tbody>
                <?php $__currentLoopData = $submission->accountSignatories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $signatory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td><?php echo e($signatory->name ?? 'N/A'); ?></td>
                        <td>
                            ...
                            <?php else: ?> <?php echo e($signatory->signature_type ?? 'N/A'); ?> <?php endif; ?>
                        </td>
    ...
    <div class="section">
        ...
        <div class="signature-area">
            ...
            <?php if($hasDirectorSignature): ?>
                <div class="signature-display" style="text-align: right;">
                    <?php echo $directorSignatureHtml; ?>
