        ...
        <div class="dashboard-main-body">
                ...
                <div class="d-flex flex-wrap align-items-start justify-content-between gap-3">
                    ...
                    <div>
                        <ul class="d-flex align-items-center gap-2 small text-muted mb-2">
                            <li><a href="<?php echo e(route('admin.dashboard')); ?>" class="hover-text-primary">Dashboard</a></li>
                            <li>/</li>
                            <li><a href="<?php echo e(route('career.index')); ?>" class="hover-text-primary">Offres</a></li>
                            <li>/</li>
                            <li>Détails</li>
                        </ul>
                        ...
                        <div class="job-meta-badges">
                            <span
                                class="badge-pill <?php echo e($job->status == 'open' ? 'badge-subtle-success' : 'badge-subtle-danger'); ?>">
                                <iconify-icon
                                    icon="<?php echo e($job->status == 'open' ? 'solar:check-circle-bold' : 'solar:close-circle-bold'); ?>"></iconify-icon>
                                <?php echo e($job->status == 'open' ? 'Ouvert' : 'Fermé'); ?>

                            </span>
                            <span class="badge-pill badge-subtle-secondary">
                                <iconify-icon icon="solar:suitcase-tag-bold"></iconify-icon>
                                <?php echo e($job->type == 'stage' ? 'Stage' : 'Emploi'); ?>

                            </span>
                            <span class="badge-pill badge-subtle-secondary">
                                <iconify-icon icon="solar:calendar-date-bold"></iconify-icon>
                                Créé le <?php echo e($job->created_at->format('d M Y')); ?>
                    ...
                    <div class="page-header-actions">
                        <a href="<?php echo e(route('career.index')); ?>" class="btn btn-danger">
                    ...
                    <div class="tab-content" id="jobDescriptionTabContent">
                        ...
                        <div class="tab-pane fade show active" id="summary-tab-pane" role="tabpanel"
                            ...
                            <p class="lead text-body-secondary mt-3">
                                <?php echo e($job->bref_description ?? 'Aucun résumé disponible pour cette offre.'); ?>
            ...
            <div class="card radius-12">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <span class="text-primary fw-bold"><?php echo e($jobApplications->total()); ?> Candidature(s)</span>
                </div>
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $jobApplications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jobApplication): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td>
                                            <div class="applicant-info">
                                                <div class="applicant-avatar">
                                                    <?php echo e(substr($jobApplication->first_name, 0, 1)); ?><?php echo e(substr($jobApplication->last_name, 0, 1)); ?>

                                                </div>
                                                <div class="applicant-details">
                                                    <span class="name"><?php echo e($jobApplication->last_name); ?>

                                                        <?php echo e($jobApplication->first_name); ?></span>
                                                    <span class="email"><?php echo e($jobApplication->email); ?></span>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <span
                                                class="fw-medium"><?php echo e($jobApplication->intitule ?? 'Non défini'); ?></span><br>
                                            <small
                                                class="text-muted"><?php echo e($jobApplication->application_type === 'emploi' ? 'Demande d\'emploi' : 'Demande de Stage'); ?></small>
                                        </td>
                                        ...
                                        <td class="text-center">
                                            <div class="table-actions">
                                                <?php if($jobApplication->cv_path && Storage::disk('public')->exists($jobApplication->cv_path)): ?>
                                                    <a href="<?php echo e(route('jobList.download', ['id' => $jobApplication->id, 'type' => 'cv'])); ?>"
                                                ...
                                                <?php if($jobApplication->motivation_letter_path && Storage::disk('public')->exists($jobApplication->motivation_letter_path)): ?>
                                                    <a href="<?php echo e(route('jobList.download', ['id' => $jobApplication->id, 'type' => 'motivation_letter'])); ?>"
...
<?php echo $__env->make('layout.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\user\Desktop\Microfinance\COCEC\resources\views/admin/jobOffer/details.blade.php ENDPATH**/ ?>