...
<body>
            ...
            <div class="row align-items-center g-5">
                ...
                <div class="col-lg-6" data-aos="fade-left" data-aos-delay="200">
                    <div class="career-intro-image-wrapper">
                        <img src="<?php echo e(URL::asset('assets/images/job-team.jpg')); ?>" alt="Équipe dynamique de la COCEC">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="offers-section page-section-light">
        <div class="container">
            ...
            <div class="row">
                <?php $__empty_1 = true; $__currentLoopData = $jobOffers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $offer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="col-md-12">
                    <div class="job-offer-card-revisited" data-aos="fade-up">
                        <div class="job-card-header">
                            ...
                            <div class="job-meta-list">
                                ...
                                <span class="job-meta-item"><i class="fas fa-calendar-alt"></i>Publié <?php echo e($offer->created_at->diffForHumans()); ?></span>
                            </div>
                        </div>
                        <div class="job-card-body">
                            <p><?php echo e(\Illuminate\Support\Str::limit($offer->bref_description, 180)); ?></p>
                        </div>
                        <div class="job-card-footer">
                            <span class="job-type-badge <?php echo e($offer->type); ?>"><?php echo e($offer->type); ?></span>
                            <a href="<?php echo e(route('career.details', $offer->id)); ?>" class="btn btn-primary">Voir les détails</a>
                        </div>
                    </div>
                </div>
    ...
    <section class="form-section page-section">
        <div class="container">
            ...
            <div class="application-form-wrapper" data-aos="fade-up">
                ...
                <form id="application-form" action="<?php echo e(route('career.apply')); ?>" method="POST" enctype="multipart/form-data" novalidate>
                    <?php echo csrf_field(); ?>
                    <div class="row g-4">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\user\Desktop\Microfinance\COCEC\resources\views/main/job/index.blade.php ENDPATH**/ ?>