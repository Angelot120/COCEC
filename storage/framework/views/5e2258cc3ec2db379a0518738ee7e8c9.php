    ...
    col.innerHTML = `
        <div class="product-card">
            ...
            <div class="product-card-body">
                ...
                <a href="<?php echo e(route('product.details')); ?>?slug=${product.slug}" class="details-link" title="Découvrir ${product.title}">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\user\Desktop\Microfinance\COCEC\resources\views/main/product/index.blade.php ENDPATH**/ ?>