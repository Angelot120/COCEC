    ...
    <section class="page-header-pro">
        ...
        <div class="container">
            <div class="page-header-content-pro" data-aos="fade-up">
                <h1 class="title-pro">Compte en Ligne</h1>
...
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <?php echo e($message); ?> <?php else: ?> Veuillez sélectionner une option. <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?></div>
                                </div>
...
unset($__errorArgs, $__bag); ?></div>
                        ...
                        <div class="form-step-content" data-step="2">
                            ...
                            <div class="row mb-3 choice-container <?php $__errorArgs = ['loc_method_physical'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                <div class="col-6">
                                    <input type="radio" name="loc_method_physical" id="desc_physique" value="description" <?php echo e(old('loc_method_physical', 'description') == 'description' ? 'checked' : ''); ?> required>
                                    <label for="desc_physique" class="choice-label"><i class="fas fa-keyboard"></i> Décrire l'adresse</label>
                                </div>
                                <div class="col-6">
                                    <input type="radio" name="loc_method_physical" id="map_physique" value="map" <?php echo e(old('loc_method_physical') == 'map' ? 'checked' : ''); ?>>
                                    <label for="map_physique" class="choice-label"><i class="fas fa-map-marked-alt"></i> Sélectionner sur une carte</label>
                                </div>
                                <div class="invalid-feedback"><?php $__errorArgs = ['loc_method_physical'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" name="residence_description" rows="4" placeholder="Indiquer ville, quartier, rue, repères..." required><?php echo e(old('residence_description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?></div>
                            ...
                            <div class="method-area" id="map-area-physique">
                                ...
                                <input type="hidden" name="residence_lat" id="latitude-physique" value="<?php echo e(old('residence_lat')); ?>" required>
                                <input type="hidden" name="residence_lng" id="longitude-physique" value="<?php echo e(old('residence_lng')); ?>" required>
...
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <?php echo e($message); ?> <?php else: ?> Ce champ est requis si applicable. <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?></div>
                                </div>
...
unset($__errorArgs, $__bag); ?>" name="activity_description" rows="3" required><?php echo e(old('activity_description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?></div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3 input-group-custom">
                                    ...
                                    <input type="text" class="form-control <?php $__errorArgs = ['ref1_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="ref1_name" value="<?php echo e(old('ref1_name')); ?>" required>
                                    <div class="invalid-feedback"><?php $__errorArgs = ['ref1_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <?php echo e($message); ?> <?php else: ?> Ce champ est requis. <?php unset($message);
...
unset($__errorArgs, $__bag); ?></div>
                                ...
                                <div class="col-md-6 mb-3 input-group-custom">
                                    ...
                                    <input type="tel" class="form-control <?php $__errorArgs = ['ref1_phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="ref1_phone" value="<?php echo e(old('ref1_phone')); ?>" pattern="\+?[0-9\s\-\(\)]{7,15}" required>
                                    <div class="invalid-feedback"><?php $__errorArgs = ['ref1_phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?></div>
                            ...
                            <div class="row choice-container <?php $__errorArgs = ['signature_method_physique'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                <div class="col-6">
                                    <input type="radio" name="signature_method_physique" id="draw_physique" value="draw" <?php echo e(old('signature_method_physique', 'draw') == 'draw' ? 'checked' : ''); ?> required>
                                    <label for="draw_physique" class="choice-label"><i class="fas fa-pencil-alt"></i> Dessiner</label>
                                </div>
                                <div class="col-6">
                                    <input type="radio" name="signature_method_physique" id="upload_physique" value="upload" <?php echo e(old('signature_method_physique') == 'upload' ? 'checked' : ''); ?>>
                                    <label for="upload_physique" class="choice-label"><i class="fas fa-upload"></i> Importer</label>
                                </div>
                                <div class="invalid-feedback"><?php $__errorArgs = ['signature_method_physique'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?></div>
                            ...
                            <div class="method-area" id="upload-area-physique">
                                <div class="file-upload-wrapper <?php $__errorArgs = ['signature_upload_physique'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                    <div class="file-upload-content">
                                        ...
                                        <p class="file-upload-text">Importer une signature (PNG)</p>
                                    </div>
                                    <div class="file-upload-preview"></div>
                                    <input type="file" name="signature_upload_physique" accept="image/png">
                                    <div class="invalid-feedback"><?php $__errorArgs = ['signature_upload_physique'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <?php echo e($message); ?> <?php else: ?> Une signature importée est requise. <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?></div>
                                </div>
...
unset($__errorArgs, $__bag); ?></div>
                        ...
                        <div class="form-step-content" data-step="3">
                            ...
                            <div class="row mb-3 choice-container <?php $__errorArgs = ['loc_method_moral'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                <div class="col-6">
                                    <input type="radio" name="loc_method_moral" id="desc_morale" value="description" <?php echo e(old('loc_method_moral', 'description') == 'description' ? 'checked' : ''); ?> required>
                                    <label for="desc_morale" class="choice-label"><i class="fas fa-keyboard"></i> Décrire l'adresse</label>
                                </div>
                                <div class="col-6">
                                    <input type="radio" name="loc_method_moral" id="map_morale" value="map" <?php echo e(old('loc_method_moral') == 'map' ? 'checked' : ''); ?>>
                                    <label for="map_morale" class="choice-label"><i class="fas fa-map-marked-alt"></i> Sélectionner sur une carte</label>
                                </div>
                                <div class="invalid-feedback"><?php $__errorArgs = ['loc_method_moral'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <?php echo e($message); ?> <?php else: ?> Veuillez choisir une méthode. <?php unset($message);
...
unset($__errorArgs, $__bag); ?></div>
                            ...
                            <div class="method-area" id="map-area-morale">
                                ...
                                <input type="hidden" name="residence_lat" id="latitude-morale" value="<?php echo e(old('residence_lat')); ?>" required>
                                <input type="hidden" name="residence_lng" id="longitude-morale" value="<?php echo e(old('residence_lng')); ?>" required>
                                <div class="invalid-feedback"><?php $__errorArgs = ['residence_lat'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?></div>
                        ...
                        <div class="form-step-content" data-step="4">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">Procès-verbal de nomination</label>
                                    <div class="file-upload-wrapper <?php $__errorArgs = ['pv_nomination_path'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                        ...
                                        <div class="invalid-feedback"><?php $__errorArgs = ['pv_nomination_path'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <?php echo e($message); ?> <?php else: ?> Le PV est requis (PDF). <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?></div>
                                    </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">Statuts de l'entité</label>
                                    <div class="file-upload-wrapper <?php $__errorArgs = ['statutes_path'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                        ...
                                        <div class="invalid-feedback"><?php $__errorArgs = ['statutes_path'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <?php echo e($message); ?> <?php else: ?> Les statuts sont requis (PDF). <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?></div>
                                    </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="file-upload-wrapper <?php $__errorArgs = ['director_photo_path'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                        ...
                                        <div class="file-upload-preview"></div>
                                        <input type="file" name="director_photo_path" accept="image/jpeg,image/png" required>
                                        <div class="invalid-feedback"><?php $__errorArgs = ['director_photo_path'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <?php echo e($message); ?> <?php else: ?> Une photo est requise. <?php unset($message);
...
unset($__errorArgs, $__bag); ?></div>
                                ...
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">Scan de la pièce d'identité du dirigeant</label>
                                    <div class="file-upload-wrapper <?php $__errorArgs = ['director_id_scan_path'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                        ...
                                        <div class="invalid-feedback"><?php $__errorArgs = ['director_id_scan_path'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <?php echo e($message); ?> <?php else: ?> Le scan (PDF) est requis. <?php unset($message);
...
unset($__errorArgs, $__bag); ?></div>
                            ...
                            <div class="row choice-container <?php $__errorArgs = ['signature_method_morale'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                <div class="col-6">
                                    <input type="radio" name="signature_method_morale" id="draw_morale" value="draw" <?php echo e(old('signature_method_morale', 'draw') == 'draw' ? 'checked' : ''); ?> required>
                                    <label for="draw_morale" class="choice-label"><i class="fas fa-pencil-alt"></i> Dessiner</label>
                                </div>
                                <div class="col-6">
                                    <input type="radio" name="signature_method_morale" id="upload_morale" value="upload" <?php echo e(old('signature_method_morale') == 'upload' ? 'checked' : ''); ?>>
                                    <label for="upload_morale" class="choice-label"><i class="fas fa-upload"></i> Importer</label>
                                </div>
                                <div class="invalid-feedback"><?php $__errorArgs = ['signature_method_morale'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <?php echo e($message); ?> <?php else: ?> Une méthode de signature est requise. <?php unset($message);
...
unset($__errorArgs, $__bag); ?></div>
                            ...
                            <div class="method-area" id="upload-area-morale">
                                <div class="file-upload-wrapper <?php $__errorArgs = ['signature_upload_morale'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                    ...
                                    <div class="invalid-feedback"><?php $__errorArgs = ['signature_upload_morale'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <?php echo e($message); ?> <?php else: ?> Une signature importée est requise. <?php unset($message);
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        forms.forEach(form => {
            ...
            // Met à jour la barre de progression et l'état des étapes
            ...
            function showStep(step) {
                ...
                // Redimensionne la carte si elle est présente dans l'étape
            ...
            function validateStep(step) {
                ...
                // Affichage de l'erreur pour le premier champ invalide
                if (!isValid) {
            ...
            // Mise à jour du total des versements
                    ...
                    <div class="dynamic-field p-3 mb-3 border rounded position-relative">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3 input-group-custom">
                                <label class="form-label">Téléphone</label>
                                <i class="icon fas fa-phone"></i>
                                <input type="tel" class="form-control" name="${type}s[${index}][phone]" pattern="\+?[0-9\s\-\(\)]{7,15}" required>
            ...
            // Gestion des méthodes de localisation (description ou carte)
            ...
            // Gestion des choix de signature
            ...
            function initializeSignaturePad(canvas, formType) {
                ...
                signaturePad.addEventListener('endStroke', updateSignatureData);
                clearBtn.addEventListener('click', () => {
                    signaturePad.clear();
                    hiddenInput.value = '';
                    form.querySelector(`#signature-draw-error-${formType}`).style.display = 'none';
                });
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\user\Desktop\Microfinance\COCEC\resources\views/main/account/create.blade.php ENDPATH**/ ?>