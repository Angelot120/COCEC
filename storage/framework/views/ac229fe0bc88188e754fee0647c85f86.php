    ...
    <section class="org-chart-section page-section">
        <div class="container">
            ...
            <div class="org-chart-wrapper" data-aos="fade-up" data-aos-delay="100">
                <img src="<?php echo e(asset('assets/images/organigramme.png')); ?>" alt="Organigramme de la COCEC">
            </div>
        </div>
    </section>
...
<?php echo $__env->make('layout.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\user\Desktop\Microfinance\COCEC\resources\views/main/about.blade.php ENDPATH**/ ?>