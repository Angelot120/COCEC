                    ...
                    <div class="faq-item-pro" data-category="produits">
                        ...
                        <div class="faq-answer-pro">
                            <div class="faq-answer-content">
                                ...
                                <p><a href="<?php echo e(route('product.index')); ?>">Consultez la liste complète des crédits</a></p>
                            </div>
                        </div>
                    </div>
                    <div class="faq-item-pro" data-category="produits">
        ...
        <div class="container">
            <div class="community-wrapper">
                ...
                <div class="comment-form-wrapper" data-aos="fade-up">
                    ...
                    <form id="main-comment-form" action="<?php echo e(route('faq.comments.store')); ?>" method="POST" novalidate><?php echo csrf_field(); ?><div class="form-grid">
                            <div class="form-group"><label for="comment-name" class="form-label">Votre Nom</label><input type="text" id="comment-name" name="name" class="form-control-pro" required value="<?php echo e(auth()->user()->name ?? ''); ?>">
                                <div class="invalid-feedback"></div>
                            </div>
                            <div class="form-group"><label for="comment-email" class="form-label">Votre Email</label><input type="email" id="comment-email" name="email" class="form-control-pro" required value="<?php echo e(auth()->user()->email ?? ''); ?>">
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
                ...
                <div class="comments-list-wrapper" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <ol class="comments-list">
                        ...
                        <li class="comment-item" id="comment-<?php echo e($comment->id); ?>">
                            <div class="comment-content">
                                <div class="comment-header"><span class="comment-author"><?php echo e($comment->name); ?> <?php if($comment->user && $comment->user->is_admin): ?><span class="support-tag">Officiel</span><?php endif; ?></span><span class="comment-date"><?php echo e($comment->created_at->diffForHumans()); ?></span></div>
                                <div class="comment-body">
                                    <p><?php echo e($comment->body); ?></p>
                                </div>
                                <div class="comment-actions"><?php if(auth()->guard()->check()): ?><button class="comment-reply-btn" data-comment-id="<?php echo e($comment->id); ?>"><i class="fas fa-reply"></i> Répondre</button><?php if(Auth::user()->is_admin || Auth::id() == $comment->user_id): ?><button class="comment-delete-btn" data-comment-id="<?php echo e($comment->id); ?>" data-delete-url="<?php echo e(route('faq.comments.destroy', $comment)); ?>" data-csrf="<?php echo e(csrf_token()); ?>"><i class="fas fa-trash"></i> Supprimer</button><?php endif; ?> <?php endif; ?></div>
                                <div class="reply-form-wrapper" id="reply-form-<?php echo e($comment->id); ?>">
                                    <form class="reply-form" action="<?php echo e(route('faq.comments.store')); ?>" method="POST" novalidate><?php echo csrf_field(); ?><input type="hidden" name="parent_id" value="<?php echo e($comment->id); ?>">
                                        <div class="form-group">
                                            <textarea name="body" class="form-control-pro" rows="3" style="width:100%; min-width:300px;" placeholder="Écrivez votre réponse à <?php echo e($comment->name); ?>..." required></textarea>
                                            <div class="invalid-feedback"></div>
                                        </div><button type="submit" class="btn-submit-comment"><span>Répondre</span></button>
                                    </form>
                                </div>
                                <?php if($comment->replies->isNotEmpty()): ?><ol class="comment-replies"><?php $__currentLoopData = $comment->replies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reply): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><li class="comment-item" id="comment-<?php echo e($reply->id); ?>">
                                        <div class="comment-content">
                                            <div class="comment-header"><span class="comment-author"><?php echo e($reply->name); ?> <?php if($reply->user && $reply->user->is_admin): ?><span class="support-tag">Officiel</span><?php endif; ?></span><span class="comment-date"><?php echo e($reply->created_at->diffForHumans()); ?></span></div>
                                            <div class="comment-body">
                                                <p><?php echo e($reply->body); ?></p>
                                            </div>
                                            <div class="comment-actions"><?php if(auth()->guard()->check()): ?><button class="comment-reply-btn" data-comment-id="<?php echo e($comment->id); ?>"><i class="fas fa-reply"></i> Répondre</button><?php if(Auth::user()->is_admin || Auth::id() == $reply->user_id): ?><button class="comment-delete-btn" data-comment-id="<?php echo e($reply->id); ?>" data-delete-url="<?php echo e(route('faq.comments.destroy', $reply)); ?>" data-csrf="<?php echo e(csrf_token()); ?>"><i class="fas fa-trash"></i> Supprimer</button><?php endif; ?> <?php endif; ?></div>
                                        </div>
                                    </li>
                        ...
                        <p class="text-center text-muted">Soyez la première personne à poser une question ou à laisser un avis !</p><?php endif; ?>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <section class="faq-contact-section-wrapper">
        <div class="container" data-aos="fade-up">
            <div class="faq-contact-section">
                ...
                <a href="<?php echo e(route('contact')); ?>" class="btn-contact-faq">Nous Contacter</a>
            </div>
        </div>
    </section>
    <br>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\user\Desktop\Microfinance\COCEC\resources\views/main/faq.blade.php ENDPATH**/ ?>