                ...
                <div class="df-update-form-container">
                    <div class="df-update-form-content">
                        <div class="df-update-form-text">
                           ...
                           <a href="<?php echo e(route('digitalfinance.updates.create')); ?>" class="df-update-form-btn">
                           ...
                           <div style="margin-top: 20px; padding-top: 20px; border-top: 1px solid rgba(255,255,255,0.2);">
                               <a href="<?php echo e(route('digitalfinance.contracts.create')); ?>" class="df-update-form-btn" style="background: rgba(255,255,255,0.2); color: white; border: 2px solid white;">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\user\Desktop\Microfinance\COCEC\resources\views/main/digitalfinance/index.blade.php ENDPATH**/ ?>