            ...
            <section class="df-update-section-clean" data-aos="fade-up">
                <div class="df-update-container-clean">
                    ...
                    <div class="df-actions-grid-clean">
                        <a href="<?php echo e(route('digitalfinance.updates.create')); ?>" class="df-action-card-clean">
                        ...
                        <a href="<?php echo e(route('digitalfinance.contracts.create')); ?>" class="df-action-card-clean">
