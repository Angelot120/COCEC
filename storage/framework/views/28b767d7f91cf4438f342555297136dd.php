            ...
            <div class="col">
                <div class="card h-100">
                    <div class="card-body text-center">
                        ...
                        <h5 class="card-title mb-1"><?php echo e($updates->total()); ?></h5>
            ...
            <div class="col">
                <div class="card h-100">
                    <div class="card-body text-center">
                        ...
                        <h5 class="card-title mb-1"><?php echo e($updates->where('status', 'pending')->count()); ?></h5>
            ...
            <div class="col">
                <div class="card h-100">
                    <div class="card-body text-center">
                        ...
                        <h5 class="card-title mb-1"><?php echo e($updates->where('status', 'approved')->count()); ?></h5>
                    ...
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <div>
                                        <div class="fw-medium"><?php echo e($update->full_name); ?></div>
                                        <?php if($update->email): ?>
                                ...
                                <td>
                                    <span class="fw-medium"><?php echo e($update->account_number); ?></span>
                                </td>
                                <td>
                                    <div>
                                        <div class="fw-medium"><?php echo e($update->cni_number); ?></div>
                                        <?php if($update->cni_type): ?>
                                            <small class="text-muted"><?php echo e($update->cni_type); ?></small>
                                        <?php endif; ?>
                                    </div>
                                </td>
                                <td>
                                    <div>
                                        <div class="fw-medium"><?php echo e($update->created_at->format('d/m/Y')); ?></div>
                                ...
                                <td>
                                    ...
                                    <?php elseif($update->status == 'approved'): ?>
                                        <span class="badge badge-approved">Approuvé</span>
                                    <?php elseif($update->status == 'rejected'): ?>
                                        <span class="badge badge-rejected">Rejeté</span>
                                    <?php else: ?>
                                        <span class="badge bg-secondary"><?php echo e($update->status); ?></span>
                                    <?php endif; ?>
                                </td>
                                <td>
                                    <div class="d-flex gap-1">
                                        <a href="<?php echo e(route('admin.digitalfinance.updates.show', $update->id)); ?>" 
                                           class="btn btn-sm btn-outline-primary" 
                                           title="Voir les détails">
                                            <iconify-icon icon="ph:eye"></iconify-icon>
                                        </a>
                                        <?php if($update->status == 'pending'): ?>
                                            <form action="<?php echo e(route('admin.digitalfinance.updates.approve', $update->id)); ?>" 
                                                  method="POST" 
                                                  class="d-inline">
                                                <?php echo csrf_field(); ?>
                                                <button type="submit" 
                                            ...
                                            <form action="<?php echo e(route('admin.digitalfinance.updates.reject', $update->id)); ?>" 
                                                  method="POST" 
                                                  class="d-inline">
                                                <?php echo csrf_field(); ?>
                                                <button type="submit" 
