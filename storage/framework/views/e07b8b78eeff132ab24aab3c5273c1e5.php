                    ...
                    <div class="card-body p-20">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <h6 class="mb-0"><?php echo e(number_format($totalVisitors)); ?></h6>
                            </div>
                    ...
                    <div class="card-body p-20">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <h6 class="mb-0"><?php echo e(number_format($totalSubscribers)); ?></h6>
                            </div>
                    ...
                    <div class="card-body p-20">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <h6 class="mb-0"><?php echo e(number_format($jobOffers)); ?></h6>
                            </div>
                            <div class="w-50-px h-50-px bg-cocec-red rounded-circle d-flex justify-content-center align-items-center">
                    ...
                    <div class="card-body p-20">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <h6 class="mb-0"><?php echo e(number_format($jobApplications)); ?></h6>
                            </div>
                            <div class="w-50-px h-50-px bg-cocec-yellow rounded-circle d-flex justify-content-center align-items-center">
...
<script>
    ...
    const visitorsByMonth = <?php echo json_encode($visitorsByMonth, 15, 512) ?>;
    const visitorsByDay = <?php echo json_encode($visitorsByDay, 15, 512) ?>;
    const visitorsByWeek = <?php echo json_encode($visitorsByWeek, 15, 512) ?>;
    const subscribersByMonth = <?php echo json_encode($subscribersByMonth, 15, 512) ?>;
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\user\Desktop\Microfinance\COCEC\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>