    ...
    <section class="page-header-pro">
        ...
        <div class="container">
            <div class="page-header-content-pro" data-aos="fade-up">
                <h1 class="title-pro"><?php echo e($offer->title); ?></h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb-pro">
                        <li class="breadcrumb-item"><a href="<?php echo e(route('index')); ?>">Accueil</a></li>
                        <li class="breadcrumb-item"><a href="<?php echo e(route('career')); ?>">Carrières</a></li>
                        <li class="breadcrumb-item active" aria-current="page"><?php echo e(\Illuminate\Support\Str::limit($offer->title, 30)); ?></li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-7 col-md-12 offer-main-content">
                    ...
                    <p><?php echo e($offer->bref_description); ?></p>
                    <div class="description-section"><?php echo $offer->description; ?></div>
                </div>
                    ...
                    <aside class="summary-card-revisited">
                        <div class="card-content">
                            <div class="card-badge-header">
                                ...
                                <span class="job-type-badge <?php echo e($offer->type); ?>"><?php echo e($offer->type); ?></span>
                            </div>
                            ...
                            <ul class="summary-list">
                                ...
                                <li><i class="fas fa-calendar-alt"></i><strong>Publié :</strong><span><?php echo e($offer->created_at->diffForHumans()); ?></span></li>
                            </ul>
    ...
    <section id="formulaire-candidature" class="page-section">
        <div class="container">
            <div class="section-header text-center">
                <h2 class="section-title">Postulez pour : <?php echo e($offer->title); ?></h2>
            ...
            <div class="premium-form-container" data-aos="fade-up">
                <form id="job-application-form" action="<?php echo e(route('career.apply.offer', $offer->id)); ?>" method="POST" enctype="multipart/form-data" novalidate>
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="intitule" value="<?php echo e($offer->title); ?>">
                    <input type="hidden" name="application_type" value="<?php echo e($offer->type); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\user\Desktop\Microfinance\COCEC\resources\views/main/job/details.blade.php ENDPATH**/ ?>